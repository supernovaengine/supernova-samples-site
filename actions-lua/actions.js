...
// include: /tmp/tmp40kbt70c.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'actions.data';
      var REMOTE_PACKAGE_BASE = 'actions.data';
...
var REMOTE_PACKAGE_SIZE = metadata['remote_package_size'];
    ...
    function runWithFS() {
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_actions.data');

      };
      Module['addRunDependency']('datafile_actions.data');
    ...
    loadPackage({"files": [{"filename": "/main.lua", "start": 0, "end": 2675}], "remote_package_size": 2675});

  })();

// end include: /tmp/tmp40kbt70c.js
