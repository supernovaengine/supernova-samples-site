...
// end include: /tmp/tmp4plubl0a.js
...
var ASM_CONSTS = {
 ...
 2007251: ($0) => { miniaudio.untrack_device_by_index($0); },  
 2007294: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 2007419: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
};
