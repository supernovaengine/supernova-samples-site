...
// end include: /tmp/tmpisqpir_l.js
...
var ASM_CONSTS = {
 ...
 2006579: ($0) => { miniaudio.untrack_device_by_index($0); },  
 2006622: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 2006747: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
};
