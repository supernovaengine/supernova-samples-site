...
// end include: /tmp/tmpnay8m_ch.js
...
var ASM_CONSTS = {
 ...
 2010419: ($0) => { miniaudio.untrack_device_by_index($0); },  
 2010462: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 2010587: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
};
