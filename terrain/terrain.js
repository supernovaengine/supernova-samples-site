...
var REMOTE_PACKAGE_SIZE = metadata['remote_package_size'];
    ...
    loadPackage({"files": [{"filename": "/blendmap.png", "start": 0, "end": 57385}, {"filename": "/block.png", "start": 57385, "end": 59237}, {"filename": "/ground.png", "start": 59237, "end": 851641}, {"filename": "/heightmap.png", "start": 851641, "end": 1084474}, {"filename": "/main.lua", "start": 1084474, "end": 1087446}], "remote_package_size": 1087446});

  })();

// end include: /tmp/tmpmkz47woy.js
...
var ASM_CONSTS = {
  1922420: () => { FS.mkdir('/datafs'); FS.mount(IDBFS, {}, '/datafs'); FS.syncfs(true, function(err) { ccall('syncfs_enable_callback', null, ['string'], [err ? err.message : ""]); }); },  
 1922586: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 1922635: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 1922684: () => { FS.syncfs(function(err) { ccall('syncfs_callback', null, ['string'], [err ? err.message : ""]); }); },  
 1922784: ($0) => { var key = UTF8ToString($0); var val = localStorage.getItem(key); if (val) { var len = lengthBytesUTF8(val)+1; var buf = _malloc(len); stringToUTF8(val, buf, len); return buf; } return null; },  
 1922978: ($0, $1) => { var key = UTF8ToString($0); var value = UTF8ToString($1); localStorage.setItem(key, value); },  
 1923074: ($0) => { var key = UTF8ToString($0); localStorage.removeItem(key); },  
