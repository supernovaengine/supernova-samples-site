...
// end include: /tmp/tmp1_vhhfe3.js
...
var ASM_CONSTS = {
 ...
 1461415: ($0) => { miniaudio.untrack_device_by_index($0); },  
 1461458: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 1461583: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
};
