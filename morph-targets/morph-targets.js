...
// end include: /tmp/tmpa4ckd535.js
...
var ASM_CONSTS = {
 ...
 1461735: ($0) => { miniaudio.untrack_device_by_index($0); },  
 1461778: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 1461903: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
};
