...
// end include: /tmp/tmp56xmlvvl.js
...
var ASM_CONSTS = {
 ...
 2010515: ($0) => { miniaudio.untrack_device_by_index($0); },  
 2010558: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 2010683: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
};
