...
// end include: /tmp/tmpq4l4z7e8.js
...
var ASM_CONSTS = {
 ...
 2010531: ($0) => { miniaudio.untrack_device_by_index($0); },  
 2010574: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 2010699: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
};
