...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'billboard.data';
      var REMOTE_PACKAGE_BASE = 'billboard.data';
...
Module['FS_createPath']("/", "ely_hills", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_billboard.data');

      };
      Module['addRunDependency']('datafile_billboard.data');
