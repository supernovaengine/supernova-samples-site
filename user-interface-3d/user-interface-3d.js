...
// include: /tmp/tmplb114n35.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'user-interface-3d.data';
      var REMOTE_PACKAGE_BASE = 'user-interface-3d.data';
...
Module['FS_createPath']("/", "ely_hills", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_user-interface-3d.data');

      };
      Module['addRunDependency']('datafile_user-interface-3d.data');
...
var ASM_CONSTS = {
  2000296: () => { FS.mkdir('/datafs'); FS.mount(IDBFS, {}, '/datafs'); FS.syncfs(true, function(err) { ccall('syncfs_enable_callback', null, ['string'], [err ? err.message : ""]); }); },  
 2000462: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 2000511: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 2000560: () => { FS.syncfs(function(err) { ccall('syncfs_callback', null, ['string'], [err ? err.message : ""]); }); },  
 2000660: ($0) => { var key = UTF8ToString($0); var val = localStorage.getItem(key); if (val) { var len = lengthBytesUTF8(val)+1; var buf = _malloc(len); stringToUTF8(val, buf, len); return buf; } return null; },  
 2000854: ($0, $1) => { var key = UTF8ToString($0); var value = UTF8ToString($1); localStorage.setItem(key, value); },  
 2000950: ($0) => { var key = UTF8ToString($0); localStorage.removeItem(key); },  
