...
// end include: /tmp/tmpirhftepa.js
...
var ASM_CONSTS = {
 ...
 1930471: ($0) => { miniaudio.untrack_device_by_index($0); },  
 1930514: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 1930639: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
};
