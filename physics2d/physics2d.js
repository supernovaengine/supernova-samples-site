...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'physics2d.data';
      var REMOTE_PACKAGE_BASE = 'physics2d.data';
...
var REMOTE_PACKAGE_SIZE = metadata['remote_package_size'];
    ...
    function runWithFS() {
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_physics2d.data');

      };
      Module['addRunDependency']('datafile_physics2d.data');
    ...
    loadPackage({"files": [{"filename": "/SoccerBall.png", "start": 0, "end": 8074}, {"filename": "/crate.png", "start": 8074, "end": 114530}], "remote_package_size": 114530});
