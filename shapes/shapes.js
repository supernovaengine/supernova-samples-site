...
var REMOTE_PACKAGE_SIZE = metadata['remote_package_size'];
    ...
    function runWithFS() {
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_shapes.data');

      };
      Module['addRunDependency']('datafile_shapes.data');
    ...
    loadPackage({"files": [{"filename": "/block.png", "start": 0, "end": 1852}, {"filename": "/main.lua", "start": 1852, "end": 1871}], "remote_package_size": 1871});
